...
class Doodle:
    def __init__(self):
        ...
        self.chinese_instruction = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text='',    font='Songti SC',
            pos=[0, 240], height=30, wrapWidth=None,color='black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        ...
        self.choice2 = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text='',    font='Arial Monospaced',
            pos=[240, 30], height=50, wrapWidth=None,color='black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.choice1_off = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text='',    font='Songti SC',
            pos=[-240, 30], height=50, wrapWidth=None,color='black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.choice2_off = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text='',    font='Songti SC',
            pos=[240, 30], height=50, wrapWidth=None,color='black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        ...
        self.reminder_off = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text='提示：请按下‘a’选择左侧选项，‘l’选择右侧选项，请不要误按其它按键。',    font='Songti SC',
            pos=[0, -240], height=20, wrapWidth=None,color='black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.image = visual.ImageStim(setup.mywin, units='pix', size =80 ,image=var.fixation, ori=0, pos=[0,0], opacity=1, interpolate=True)
