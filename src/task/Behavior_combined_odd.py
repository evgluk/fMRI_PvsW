# -*- coding: utf-8 -*-
# Run this file for combined fMRI experiment (ShortfMRI+longfMRI+shortfMRI+longfMRI)
#-------------------imports--------------------------------------------------------------------
...
#---------------Main Function-------------------------------------
def Behavior_combined_odd(var,doo,myPoints):
    ...
    p_num, points_short1,trials_short1,trialsCorrect_short1= ShortDelay_Behavior.ShortDelay_Behavior(var,doo,myPoints) # run short verbal session #1
    var.blockName+=1
    fc.block_break(var,doo) # show the break instruction to subject
    p_num,pick1,pay_delay1,pay_num1,trials_long1,points_long1 = LongDelay_Behavior.LongDelay_Behavior(var,doo,myPoints,getName=False,getRun=False,sub_id=p_num) # run the first long verbal session and record the returned info
    var.blockName+=1
    fc.block_break(var,doo) # show the break instruction to subject
...
if __name__ == "__main__":
    ...
    doo = doodle.Doodle()
    Behavior_combined_odd(var,doo,myPoints) # call main function
